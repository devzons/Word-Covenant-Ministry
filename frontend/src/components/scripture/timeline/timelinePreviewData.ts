...
export const passionWeekTimelineEvents: TimelineEvent[] = [
  ...
  createEvent({
    id: "joseph-egypt",
    title: { en: "Joseph in Egypt", ko: "애굽의 요셉" },
    summary: { en: "The covenant family is carried into Egypt.", ko: "언약 가족이 애굽으로 옮겨집니다." },
    periodId: "patriarchs",
    primaryBookId: "genesis",
    relatedBookIds: ["acts"],
    scriptureAnchors: [
      createAnchor(
        { en: "Genesis 37:1-36", ko: "창세기 37:1-36" },
        { book: "genesis", chapter: 37, verse: 1, translation: { en: "WEB", ko: "KRV" } },
      ),
      createAnchor(
        { en: "Genesis 41:1-57", ko: "창세기 41:1-57" },
        { book: "genesis", chapter: 41, verse: 1, translation: { en: "WEB", ko: "KRV" } },
      ),
    ],
    ...
    eventType: { en: "Providence / exile seed", ko: "섭리 / 포로의 씨앗" },
    reader: { book: "genesis", chapter: 37, verse: 1, translation: { en: "WEB", ko: "KRV" } },
  }),
  createEvent({
    id: "exodus-passover",
