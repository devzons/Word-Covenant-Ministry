...
```txt
Choose the next post-CR-93D package-verifier or core-event branch without changing API, DB, schema, or import scope.
```

Next task:

```txt
Choose between CR-93E Timeline Package Verifier Design, CR-93C Core Biblical Event Skeleton, and CR-93D-2 66-Book Frontend Preview Integration before broadening Timeline fixture data further.
```
