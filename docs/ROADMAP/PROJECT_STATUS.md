...
```txt
Choose the next post-CR-93B package-skeleton or core-data branch without changing API, DB, schema, or import scope.
```

Next task:

```txt
Choose between CR-93B-2 Timeline Data Package Skeleton Files, CR-93C Core Biblical Event Skeleton, and CR-93D 66-Book Context Skeleton before broadening Timeline fixture data further.
```
