...
```txt
Choose the next post-CR-93E verifier-fixture, minimal-verifier, or runtime-integration branch without changing API, DB, schema, or import scope.
```

Next task:

```txt
Choose between CR-93E-2 Verifier Test Fixtures, CR-93E-3 Minimal Verifier Implementation, CR-93C Core Biblical Event Skeleton, and CR-93D-2 66-Book Frontend Preview Integration before broadening Timeline fixture data further.
```
