...
```txt
Choose the next post-CR-93A Timeline data-architecture branch without changing API, DB, schema, or import scope.
```

Next task:

```txt
Choose between CR-93B Timeline Data Package Design and CR-93C Core Biblical Event Skeleton before broadening Timeline fixture data further.
```
