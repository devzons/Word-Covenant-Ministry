...
```txt
Choose the next Timeline preview branch after the Exodus / Wilderness preview.
```

Next task:

```txt
Choose between CR-90C-5 Conquest / Judges Scripture-First Timeline Preview, Kings & Kingdoms Preview, Psalms / Book Context Preview, Matthew Genealogy Comparison Preview, or Place / Map Preview.
```
