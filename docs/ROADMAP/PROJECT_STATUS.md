...
```txt
Choose the next post-CR-91E/CR-93D runtime-integration or package-verifier branch without changing API, DB, schema, or import scope.
```

Next task:

```txt
Choose between CR-93D-2 66-Book Frontend Preview Integration, CR-93E Timeline Package Verifier Design, and CR-93C Core Biblical Event Skeleton before broadening Timeline fixture data further.
```
