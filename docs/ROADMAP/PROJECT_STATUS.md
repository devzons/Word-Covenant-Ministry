...
```txt
Choose the next Timeline preview branch after the layout expansion.
```

Next task:

```txt
Choose between Expanded Scripture-First Content Fixture, Kings & Kingdoms Preview, Psalms / Book Context Preview, Matthew Genealogy Comparison Preview, or Place / Map Preview.
```
