...
```txt
Choose the next Timeline refinement branch after the Books / Psalms and Kings supplementation.
```

Next task:

```txt
Choose between CR-90Y-5 Genealogy Detail Refinement, CR-90Y-4B Kings / Prophets Cross-Link Refinement, or CR-91 Place / Map Preview.
```
