...
```txt
Choose between CR-90C-6 Samuel / United Kingdom Scripture-First Timeline Preview, Kings & Kingdoms Preview, Psalms / Book Context Preview, Matthew Genealogy Comparison Preview, or Place / Map Preview.
```
