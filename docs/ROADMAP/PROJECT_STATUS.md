...
```txt
Choose the next post-CR-93B-2 core-data or verifier-design branch without changing API, DB, schema, or import scope.
```

Next task:

```txt
Choose between CR-93C Core Biblical Event Skeleton, CR-93D 66-Book Context Skeleton, and CR-93E Timeline Package Verifier Design before broadening Timeline fixture data further.
```
