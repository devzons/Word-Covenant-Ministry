...
```txt
Choose between CR-93D-2 66-Book Frontend Preview Integration, CR-93C-2 Core Event Skeleton Frontend Preview Integration, and later CI wiring before broadening Timeline fixture data further.
```
