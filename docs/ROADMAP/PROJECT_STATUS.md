...
```txt
Choose the next Timeline preview branch after the Conquest / Judges preview.
```

Next task:

```txt
Choose between CR-90F Matthew Genealogy Comparison Preview, CR-90E-2 Book Context Detail Refinement, CR-90D-3 Kings Detail / Name Variant Preview, or Place / Map Preview.
```
