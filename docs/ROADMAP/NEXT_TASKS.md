...
23. Recommended next CR: `CR-BR-CTX-54 Chapter Context Hidden Handoff QA or Read-Only Display Gate`. This should either verify the non-rendering client-boundary handoff remains safe, or define the smallest approved read-only Context-tab display boundary before any visible chapter-context UI is added.
