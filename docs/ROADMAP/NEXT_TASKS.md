...
47. Recommended next CR: `CR-BR-CTX-82 Reader Verse Selection Manual Browser Acceptance`. This should perform a real local browser pass on body, original-text, and interlinear modes to confirm click and keyboard verse selection, active highlight, `#v{verse}` hash updates, research-workspace related-passage updates, and unchanged chapter-context boundaries in a user-visible environment.
