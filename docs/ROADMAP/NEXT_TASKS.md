...
22. Recommended next CR: `CR-BR-CTX-53 Chapter Context Reader Adapter Handoff Readiness`. This should define or implement the smallest safe server-to-client handoff for reviewed chapter-context rows without yet expanding Reader UI claims beyond chapter-level preview metadata.
