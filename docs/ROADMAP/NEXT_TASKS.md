...
30. Recommended next CR: `CR-BR-CTX-61 Chapter Context Manual Keyboard and Assistive Technology Verification`. This should focus on manual keyboard traversal, focus visibility, heading announcements, and screen-reader phrasing on the live Reader surface with real assistive technology enabled locally.
