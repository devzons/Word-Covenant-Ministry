...
CR-90D Kings, Kingdoms, and Surrounding Empires Preview is complete through available validation. The Scripture Timeline now includes a lightweight Kings & Kingdoms preview view, kingdom / empire / ruler / prophet context fields, and the same left sidebar navigator, a main workspace area, and a right detail panel while remaining Scripture-first and page-stay oriented. Staging and release work remain paused until the next Timeline preview branch is chosen.
