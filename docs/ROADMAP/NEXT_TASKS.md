...
46. Recommended next CR: `CR-BR-CTX-80 Chapter Context Batch 3 Accessibility and Regression Spot Check`. This should perform a narrow no-row-change regression review across the current `16` reviewed chapter-context routes, confirm the existing supplemental presentation and heading/list semantics remain intact, and close without changing Reader/runtime behavior unless a concrete accessibility defect is found.
