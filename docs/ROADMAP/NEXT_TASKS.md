...
29. Recommended next CR: `CR-BR-CTX-60 Chapter Context Keyboard and Screen Reader QA`. This should focus on manual keyboard traversal, focus order, heading/label announcements, and screen-reader phrasing for the current `Context / 문맥` tab without expanding chapter-context scope or adding new data behavior.
