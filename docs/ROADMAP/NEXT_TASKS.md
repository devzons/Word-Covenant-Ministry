...
41. Recommended next CR: `CR-BR-CTX-75 Chapter Context Batch 3 Draft Row QA`. This should validate the `6` new Batch 3 draft rows for deterministic identity, required field presence, conservative event relations, wording safety, and verifier cleanliness while keeping them in `draft` state.
