...
27. Recommended next CR: `CR-BR-CTX-58 Chapter Context Interactive Browser QA Follow-Up`. This should verify the polished section in a real local browser session with manual tab interaction, spacing review, and keyboard flow confirmation, since Apple Events-based DOM automation remains disabled on the current machine.
