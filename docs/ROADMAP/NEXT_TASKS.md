...
CR-90A-3 Scripture-First Timeline Workspace Design and Data Source Documentation is now complete. The Scripture Timeline preview content model has been consolidated into a Scripture-first workspace direction that distinguishes authoritative Scripture anchors from supporting layers such as authorship notes, canonical order, map support, and external chronology candidates. Staging and release work remain paused.
...
1. Timeline Workspace Layout Expansion.
