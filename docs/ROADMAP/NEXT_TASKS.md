...
31. Recommended next CR: `CR-BR-CTX-64 Chapter Context Accessibility Regression Watch`. This should keep chapter-context preview stable during future Reader surface changes, with no new data-package or API scope unless a separate approval CR authorizes it.
