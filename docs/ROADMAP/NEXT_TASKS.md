...
33. Recommended next CR: `CR-BR-CTX-67 Chapter Context Second Pilot Draft Row QA`. This should inspect the `6` new draft rows for field consistency, wording safety, conservative relation use, verifier warnings, and readiness for later self-check/promotion without changing the existing reviewed rows.
