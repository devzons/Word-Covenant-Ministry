...
32. Recommended next CR: `CR-BR-CTX-66 Chapter Context Second Pilot Row Authoring`. This should author the approved `6` expansion rows using the current reviewed-only package contract, conservative related ids, and the existing Reader/runtime boundaries without adding selected-verse filtering, entity resolution, or API/backend/schema scope.
