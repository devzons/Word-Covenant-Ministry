...
45. Recommended next CR: `CR-BR-CTX-79 Chapter Context Batch 3 Expanded Browser QA and Manual Acceptance`. This should perform a real local browser pass on the same reviewed Batch 3 routes, confirm the `Context / 문맥` tab presentation and fallback hiding behavior visually, and record manual acceptance without changing Reader/runtime behavior unless a concrete UI defect is found.
