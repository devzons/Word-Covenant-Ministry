...
| Kings / Kingdoms skeleton package | `docs/data-packages/timeline/kings-kingdoms.skeleton.json` | 20 | Skeleton package created; frontend preview pending |
...
| Kings / Kingdoms | Comparison of rulers, kingdoms, prophets, empires | `timelineKingdomComparisonRows` plus `kings-kingdoms.skeleton.json` | Expanded frontend preview; skeleton package created; verifier fixtures created; frontend package integration pending | Strongest non-event supporting table; inspector cross-links exist; package design, skeleton baseline, and fixture baseline now exist | Full king sequence and prophet coverage remain incomplete; no route loader or package-backed frontend preview yet; verifier hardening is still pending for kingdom-specific semantics | Harden verifier rules where needed, then add frontend preview integration |
