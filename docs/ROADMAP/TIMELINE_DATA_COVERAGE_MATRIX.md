...
| Kings / Kingdoms skeleton package | `docs/data-packages/timeline/kings-kingdoms.skeleton.json` | 20 | Skeleton package created; verifier hardened; frontend preview pending |
...
| Kings / Kingdoms | Comparison of rulers, kingdoms, prophets, empires | `timelineKingdomComparisonRows` plus `kings-kingdoms.skeleton.json` | Expanded frontend preview; skeleton package created; verifier fixtures created; verifier hardening complete; frontend package integration pending | Strongest non-event supporting table; inspector cross-links exist; package design, skeleton baseline, fixture baseline, and Kings-specific verifier checks now exist | Full king sequence and prophet coverage remain incomplete; no route loader or package-backed frontend preview yet | Add frontend preview integration against the current skeleton baseline |
