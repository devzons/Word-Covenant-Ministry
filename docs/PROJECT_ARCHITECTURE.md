...
- `docs/PROJECTS/MEANING_CARD_PILOT_SPECIFICATION.md`: pilot standard for the first Meaning Card, including hierarchy, disclosure, evidence preview, and research links.
...
- `docs/EDITORIAL_STYLE_GUIDE.md`: project-wide editorial constitution for language, citation, terminology, typography, and review-state presentation.
